...
export function registerDaemonCommands(program: Command): void {
  ...
  daemonCmd
    ...
    .option('--endpoint <url>', 'Factory Floor endpoint (or AGENTS_FACTORY_URL env)', process.env.AGENTS_FACTORY_URL || 'https://factory.example.com')
...
async function runReportDaemon(options: {
  ...
  const endpoint = options.endpoint || config.endpoint || 'https://factory.example.com';
