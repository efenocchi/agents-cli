    ...
    .action(async () => {
      try {
        ...
        try {
          ...
          await execAsync(`gh repo fork phnx-labs/.agents --clone=false`);
        ...
        await setUpstreamRemote(agentsDir, 'https://github.com/phnx-labs/.agents.git');
        ...
        console.log(chalk.gray(`  upstream -> phnx-labs/.agents`));
