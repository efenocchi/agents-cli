...
<nav>
  ...
  <a href="https://www.npmjs.com/package/@companion/agents-cli">npm</a>
</nav>
...
<p class="muted">Or <code>npm install -g @companion/agents-cli</code> — also available as <code>ag</code>.</p>
...
<span class="dim">$</span> bun install -g @companion/agents-cli

<span class="dim">#</span> via npm
<span class="dim">$</span> npm install -g @companion/agents-cli</pre>
